...
>
> **Modal Migration**: Per [ADR-002](../adr/002-modal-serverless-migration.md), the compute layer has migrated from the legacy CrewAI managed platform to Modal serverless.
