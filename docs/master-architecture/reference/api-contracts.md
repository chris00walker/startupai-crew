...
> **Architectural Update (2026-01-19)**: Phase 0 API simplified to Quick Start. The previous onboarding interview endpoints are deprecated.
...
> - [04-phase-0-onboarding.md](../04-phase-0-onboarding.md) - Quick Start (simple form)
...
## Phase 0: Quick Start API

> **Architectural Update (2026-01-19)**: Phase 0 was simplified from interview endpoints to a single Quick Start endpoint. The previous interview and brief endpoints are deprecated.

Phase 0 captures minimal user input and triggers Phase 1 immediately.

### Endpoints

| Endpoint | Method | Purpose | Status |
|----------|--------|---------|--------|
| `/api/projects/quick-start` | POST | Create project + trigger Phase 1 | Active |
| ~~`/interview/start`~~ | ~~POST~~ | ~~Start founder interview~~ | **DEPRECATED** |
| ~~`/interview/continue`~~ | ~~POST~~ | ~~Continue interview~~ | **DEPRECATED** |
| ~~`/brief/create`~~ | ~~POST~~ | ~~Create Founder's Brief~~ | **DEPRECATED** |
| ~~`/brief/{brief_id}/approve`~~ | ~~POST~~ | ~~Approve brief~~ | **DEPRECATED** |

### Quick Start Request
```bash
curl -X POST https://app.startupai.site/api/projects/quick-start \
  -H "Authorization: Bearer {token}" \
  -H "Content-Type: application/json" \
  -d '{
...
The previous interview API required:
- 30+ minutes of AI conversation
- $17+ in AI costs per user
- Non-deterministic results (57-92% variance)

Quick Start requires:
- 30 seconds of user input
- $0 AI costs for Phase 0
- 100% deterministic behavior

The Founder's Brief is now generated by Phase 1 from research, not collected through interview.
...
| Component | Status |
|-----------|--------|
| `/api/projects/quick-start` | ✅ Active |
| ~~`/interview/start`~~ | ❌ DEPRECATED |
| ~~`/interview/continue`~~ | ❌ DEPRECATED |
| ~~`/brief/create`~~ | ❌ DEPRECATED (moved to Phase 1) |
| ~~`/brief/{id}` GET~~ | ❌ DEPRECATED (moved to Phase 1) |
| ~~`/brief/{id}` PUT~~ | ❌ DEPRECATED (moved to Phase 1) |
| ~~`/brief/{id}/approve`~~ | ❌ DEPRECATED (now `approve_discovery_output` in Phase 1) |
...
**Latest Changes (2026-01-19 - Phase 0 Quick Start pivot)**:
- Phase 0 API simplified to single `/api/projects/quick-start` endpoint
- Marked all interview/brief endpoints as DEPRECATED (moved to Phase 1)
- Updated HITL example to use `approve_discovery_output` (replaces `approve_founders_brief`)
- Updated Status Response example to reflect Quick Start (no OnboardingCrew)
- Updated Implementation Status to reflect new Phase 0 architecture
