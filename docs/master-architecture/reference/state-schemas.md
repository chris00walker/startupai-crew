...
class FoundersBrief(BaseModel):
    """Founder's Brief generated by BriefGenerationCrew in Phase 1 Stage A."""
...
|------------|----------|---------|------------------|
| Phase 0 | Phase 1 | (automatic) | Quick Start form submitted |
| Phase 1 Stage A | Phase 1 Stage B | `approve_brief` | Brief approved/edited |
| Phase 1 Stage B | Phase 2 | `approve_discovery_output` | fit_score >= 70 |
